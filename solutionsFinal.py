...
for each_image in sorted_images:
    ...
    if substring in result:
        cv2.imwrite(rf'C:\Users\nharw\PycharmProjects\PDF2Anki\output_Folders\solution_images_FINAL\{answer_counter}.jpg', img)
        answer_counter += 1

    elif substring not in result:
        cv2.imwrite(rf'C:\Users\nharw\PycharmProjects\PDF2Anki\output_Folders\solution_images_FINAL\{answer_counter}.jpg', img)
        prev_image = cv2.imread(
            rf'C:\Users\nharw\PycharmProjects\PDF2Anki\output_Folders\solution_images_FINAL\{answer_counter-1}.jpg', 0) # "-1" is important
        curr_image = cv2.imread(rf'C:\Users\nharw\PycharmProjects\PDF2Anki\output_Folders\solution_images_FINAL\{answer_counter}.jpg', 0)
        ...
        cv2.imwrite(rf'C:\Users\nharw\PycharmProjects\PDF2Anki\output_Folders\solution_images_FINAL\{file_name}', combined_solution)
